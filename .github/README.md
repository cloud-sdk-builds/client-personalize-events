...
[`@aws-sdk/client-personalize-events`](https://www.npmjs.com/package/@aws-sdk/client-personalize-events/v/3.513.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-personalize-events@3.513.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-uitgLSSHQBYtiPFB0dgGZifUJulgg+OP/l28X7cbtY+MZCiqW5HrQAZpXnzuChhk
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-personalize-events": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-personalize-events@3.513.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-personalize-events@3.513.0/index.min.mjs": "sha384-uitgLSSHQBYtiPFB0dgGZifUJulgg+OP/l28X7cbtY+MZCiqW5HrQAZpXnzuChhk"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-personalize-events/blob/refs/tags/3.513.0/LICENSE
```
