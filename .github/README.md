...
[`@aws-sdk/client-personalize-events`](https://www.npmjs.com/package/@aws-sdk/client-personalize-events/v/3.201.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-personalize-events@3.201.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-WSHsKDy+qzAziPlKOKRSbx6ER9LMg0BVFS63eq5pteD0V4zMkS1X95QRCxG65DhT
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-personalize-events": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-personalize-events@3.201.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-personalize-events@3.201.0/index.min.mjs": "sha384-WSHsKDy+qzAziPlKOKRSbx6ER9LMg0BVFS63eq5pteD0V4zMkS1X95QRCxG65DhT"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-personalize-events/blob/refs/tags/3.201.0/LICENSE
```
